...
namespace p_Fisher
{
    public partial class installer : Form
    {
        ...
        private static void making_shorcut(string installationPath, string targetPath)
        {
            ...
            #region Set shortcut properties
        ...
        private void install(object sender, EventArgs e)
        {
            if (install_cancel.Text == "Finish")
            {
                ...
                {
                    if (open.Checked)
                        System.Diagnostics.Process.Start(Path.Combine(path_txtbox.Text, @"bin\Debug\p'Fisher.exe"));
                } 
                catch { }
            ...
            try
            {
                ...
                #region Deleting files from the destination
                ...
                #region Getting rid of unnecessary operations
                ...
                #region Create a shortcut on the desktop (if selected)
                ...
                #region Add to Start Menu (if selected)
